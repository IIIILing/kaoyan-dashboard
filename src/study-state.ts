...
export const defaultStudyState: StudyState = {
  ...
  subjects: [
    ...
    },
    {
      ...
      note: "计划 7 月底完成单词第一轮",
      phases: [
        { id: "eng-word", name: "单词一轮", weight: 20, progress: 85 },
        { id: "eng-read", name: "阅读真题", weight: 35, progress: 0 },
        { id: "eng-other", name: "翻译与完形", weight: 15, progress: 0 },
        { id: "eng-write", name: "写作", weight: 20, progress: 0 },
        { id: "eng-mock", name: "套卷模考", weight: 10, progress: 0 },
      ],
    },
    {
      id: "politics",
    ...
    },
    {
      ...
      note: "专业课尚未开始",
      phases: [
        { id: "cir-basic", name: "教材与基础", weight: 35, progress: 0 },
        { id: "cir-exercise", name: "章节习题", weight: 25, progress: 0 },
        { id: "cir-real", name: "历年真题", weight: 30, progress: 0 },
        { id: "cir-mock", name: "模考复盘", weight: 10, progress: 0 },
      ],
    },
  ],
  sessions: [],
